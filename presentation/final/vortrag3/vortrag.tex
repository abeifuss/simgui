...
\small{
   ...
   \end{tabular}
    ...
    \begin{block}{Entscheidung für Annotations}
    Für GUI-Benutzer ist die verwendete Technik transparent.\\
    Plugin-Entwickler profitieren von den Annotations.
    Daher nehmen wir den Mehraufwand bei der Programmierung des Frameworks in Kauf.
    \end{block}
}
