...
public class MixPlugIn extends Implementation implements Layer3OutputStrategyMix {
	...
	public void constructor() {
		this.POOL_SIZE = settings.getPropertyAsInt("/gMixConfiguration/composition/layer3/mix/plugIn/thresholdPoolPoolSize");
		this.THRESHOLD = settings.getPropertyAsInt("/gMixConfiguration/composition/layer3/mix/plugIn/thresholdPoolThreshold");
