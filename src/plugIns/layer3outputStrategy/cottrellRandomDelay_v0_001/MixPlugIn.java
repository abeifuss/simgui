...
public class MixPlugIn extends Implementation implements Layer3OutputStrategyMix {
	...
	public void constructor() {
		try {
			MixPlugIn.secureRandom = SecureRandom.getInstance(settings.getPropertyAsString("/gMixConfiguration/composition/layer3/mix/plugIn/cottrellRandomDelayPrngAlgorithm"));
		} catch (NoSuchAlgorithmException e) {
			e.printStackTrace();
			throw new RuntimeException("could not init secureRandom"); 
		}
		this.maxDelay = settings.getPropertyAsInt("/gMixConfiguration/composition/layer3/mix/plugIn/cottrellRandomDelayMaxDelay");
	}
