 ...
 */
package plugIns.layer3outputStrategy.logarithmicPool_v0_001;
...
public class MixPlugIn extends Implementation implements Layer3OutputStrategyMix {
	...
	public void constructor() {
		this.DEFAULT_POOL_SIZE = settings.getPropertyAsInt("/gMixConfiguration/composition/layer3/mix/logPoolDefaultPoolSize");
		this.SEND_INTERVAL = settings.getPropertyAsInt("/gMixConfiguration/composition/layer3/mix/logPoolSendInterval");
	...
	public class SimplexBinomialPool implements Runnable {
		...
		public void putOutMessages() {
			synchronized (this) {
				...
				double coinBias = 1d - (Math.log(M)/M);
