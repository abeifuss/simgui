...
public class ClientHandler_TCP_FCFS_async_netty_2 extends SubImplementation
	...
	public void constructor() {
		...
		_factory = new NioServerSocketChannelFactory(
				...
				Executors.newCachedThreadPool());
		_port = settings.getPropertyAsInt("/gMixConfiguration/general/mixBindPort");
		_bindAddress = settings
				.getPropertyAsInetAddress("/gMixConfiguration/general/mixBindAddress");

		_userMap = new HashMap<Channel, User>();
		_channelMap = new HashMap<User, Channel>();
		_maxRequestLength = settings.getPropertyAsInt("/gMixConfiguration/composition/layer1/client/plugIn/maxRequestLength");
