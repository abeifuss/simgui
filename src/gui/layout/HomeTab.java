...
public class HomeTab extends JPanel{
	...
	public HomeTab() {
		...
		JTextArea tutorialText = new JTextArea("If you are new to gMixSim, it might be helpful to inspect our [Tutorial] section. There you will find video-guides explaining how to use this software.");
		tutorialText.setLineWrap(true);
		tutorialText.setWrapStyleWord(true);
		tutorialText.setBackground(bg);
		
		JTextArea simulatorText = new JTextArea("The [Simulator] section is where you find the experiment configurations. You can select a set of experiments and run them.");
		simulatorText.setLineWrap(true);
		simulatorText.setWrapStyleWord(true);
		simulatorText.setBackground(bg);
	    
		JTextArea resultsText = new JTextArea("The results of the experiment series are presented in the [Results] section.");
		resultsText.setLineWrap(true);
		resultsText.setWrapStyleWord(true);
		resultsText.setBackground(bg);
	    
		JTextArea HelpText = new JTextArea("If you have touble with the configuration of an experiment, you will propably find helpful information in the [Help] section.");
