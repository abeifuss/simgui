...
public class UserConfigService {
	...
	public static Boolean getGUISERVICE_TOGGLE_HOME_TAB(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+GUISERVICE_TOGGLE_HOME_TAB);
	...
	public static Boolean getGUISERVICE_SEPERATE_CONSOLE(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+GUISERVICE_SEPERATE_CONSOLE);
	...
	public static Boolean getGUISERVICE_SEPERATE_HELP_TOOL(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+GUISERVICE_SEPERATE_HELP_TOOL);
	...
	public static Boolean getGUISERVICE_SEPERATE_CONF_TOOL(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+GUISERVICE_SEPERATE_CONF_TOOL);
	...
	public static Integer getMAINGUI_CONSOLE_HEIGHT(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+MAINGUI_CONSOLE_HEIGHT);
	...
	public static Integer getMAINGUI_HSPLIT_DEVIDER_LOCATION(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+MAINGUI_HSPLIT_DEVIDER_LOCATION);
	...
	public static Integer getMAINGUI_HEIGHT(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+MAINGUI_HEIGHT);
	...
	public static Integer getMAINGUI_WIDTH(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+MAINGUI_WIDTH);
	...
	public static Integer getMAINGUI_YPOS(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+MAINGUI_YPOS);
	...
	public static Integer getMAINGUI_XPOS(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+MAINGUI_XPOS);
	...
	public static Integer getCONFTOOLFRAME_HEIGHT(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+CONFTOOLFRAME_HEIGHT);
	...
	public static Integer getCONFTOOLFRAME_WIDTH(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+CONFTOOLFRAME_WIDTH);
	...
	public static Integer getCONFTOOLFRAME_YPOS(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+CONFTOOLFRAME_YPOS);
	...
	public static Integer getCONFTOOLFRAME_XPOS(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+CONFTOOLFRAME_XPOS);
	...
	public static Integer getHELPFRAME_HEIGHT(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+HELPFRAME_HEIGHT);
	...
	public static Integer getHELPFRAME_WIDTH(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+HELPFRAME_WIDTH);
	...
	public static Integer getHELPFRAME_YPOS(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+HELPFRAME_YPOS);
	...
	public static Integer getHELPFRAME_XPOS(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+HELPFRAME_XPOS);
	...
	public static Integer getCONSOLEFRAME_HEIGHT(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+CONSOLEFRAME_HEIGHT);
	...
	public static Integer getCONSOLEFRAME_WIDTH(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+CONSOLEFRAME_WIDTH);
	...
	public static Integer getCONSOLEFRAME_YPOS(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+CONSOLEFRAME_YPOS);
	...
	public static Integer getCONSOLEFRAME_XPOS(){
		...
		if (result != null){
			...
			logger.log(Level.INFO, "Using default value for Item "+CONSOLEFRAME_XPOS);
	...
	private static Boolean getBool(String item) {
		...
		if (readValue.equals("true") || readValue.equals("false")){
			...
			logger.log(Level.INFO, "Item:  "+item+" could not be parsed to a boolean");
			return null;
		}
	}
	...
	private static void setBool(String key, boolean value) {
		try {
			...
			logger.log(Level.INFO,"Could not save item "+key+" to userConfig file!");
		}
	}
