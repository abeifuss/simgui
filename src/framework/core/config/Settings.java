...
public class Settings {
	...
	public int getPropertyAsInt(String key) {
		...
		try {
			...
			throw new RuntimeException("could not read " + key
					+ " from property file; " + properties.getProperty(key)
					+ " is not an Integer");
		}
	...
	public boolean getPropertyAsBoolean(String key) {
		...
		return value.equals("TRUE") || value.equals("true")
				|| value.equals("True") || value.equals("ON")
	...
	public void addProperties(String[] passthroughParameters) {
		String[] parameters = passthroughParameters[0].split("\\r?\\n");
		for (String parameter : parameters) {
			String[] keyValue = parameter.split("=");
			if (keyValue.length > 1) {
				System.out.println("setting " + keyValue[0] + " to "
						+ keyValue[1]);
	...
	public static Properties overwriteSettings(Properties properties,
			String args) {
		if (args != null) {
			if (!args.contains("=")) // TODO
				throw new RuntimeException(
						"invalid parameter: "
								+ args
								+ ". Example: java -jar gMixFramework.jar mix DUPLEX_ON=FALSE,ADDRESS=AUTO;PORT=AUTO");
			String[] keyValuePairs = args.split(",");
			System.out.println("args: " + args); // TODO
			System.out.println("splitting into " + keyValuePairs.length
					+ " keyValuePairs"); // TODO
	...
	public static Properties overwriteExistingSettings(Properties properties,
			String args) {
		if (args != null) {
			if (!args.contains("=")) // TODO
				throw new RuntimeException(
